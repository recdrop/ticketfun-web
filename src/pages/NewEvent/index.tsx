          ...
          <div className='flex flex-1 flex-col bg-white rounded-md p-5'>
            ...
            <div className='flex flex-1 flex-col mt-3'>
              ...
              <div className='flex flex-1 mt-3 justify-end'>
                  <button className='h-10 w-32 bg-red-700 mr-2 text-white font-bold rounded-md text-base uppercase'>Cancelar</button>
                  <button className='h-10 w-32 bg-purple-700 text-white font-bold rounded-md text-base uppercase'>Salvar</button>
              </div>
